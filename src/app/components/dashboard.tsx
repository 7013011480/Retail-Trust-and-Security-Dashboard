...
export function Dashboard() {
  ...
  const handleSubmitDecision = (
    ...
    setTransactions((prev) =>
      prev.map((t) =>
        t.id === transactionId
          ? { ...t, status: status as any, fraud_category: category, notes }
          : t
      )
    );
    ...
    setAlerts((prev) =>
      prev.map((alert) =>
        alert.transaction_id === transactionId
  ...
  const getFilteredTransactions = () => {
    ...
    return filtered.sort((a, b) => b.fraud_probability_score - a.fraud_probability_score);
  };
    ...
    <div className="h-screen flex flex-col bg-gray-950">
      ...
      <div className="bg-gray-900 border-b border-gray-800 px-6 py-4">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <Card 
            className={`bg-red-950/30 border-red-600/50 p-4 cursor-pointer transition-all hover:bg-red-950/50 ${
              activeFilter === 'high' ? 'ring-2 ring-red-500' : ''
            }`}
          ...
          <Card 
            className={`bg-amber-950/30 border-amber-600/50 p-4 cursor-pointer transition-all hover:bg-amber-950/50 ${
              activeFilter === 'medium' ? 'ring-2 ring-amber-500' : ''
            }`}
          ...
          <Card 
            className={`bg-gray-800/50 border-gray-700 p-4 cursor-pointer transition-all hover:bg-gray-800 ${
